...
static const f413_mode5_case0_sub_t k_suction_case0_subs[10] = {
  ...
  {8U, "mode5-case0-sub6 R135 in",    {204U, 901U, 1003U},               3U},
  {8U, "mode5-case0-sub7 L135 out",   {204U, 901U, 1003U, 904U, 203U},   5U},
  {1U, "mode5-case0-sub8 straight case1", {209U},                       1U},
  {5U, "mode5-case0-sub9 straight case5", {209U},                       1U},
};
...
void f413_mode5_run_case0_sub(uint8_t sub)
{
  ...
  const f413_mode5_case0_sub_t* tests = (shortestRunModeParams5.fan_power > 0)
