...
static const f413_mode6_case0_sub_t k_case0_subs[10] = {
  ...
  {1U, "mode6-case0-sub2 large R180",     {206U, 502U, 0U, 0U},       2U},
...
static const f413_mode6_case0_sub_t k_suction_case0_subs[10] = {
  {1U, "mode6-case0-sub0 small R90",  {203U, 300U, 203U},                3U},
  {2U, "mode6-case0-sub1 large R90",  {204U, 501U, 203U},                3U},
  {2U, "mode6-case0-sub2 large R180", {206U, 502U, 203U},                3U},
  {8U, "mode6-case0-sub3 R45 in",     {204U, 701U, 1003U},               3U},
  {8U, "mode6-case0-sub4 L45 out",    {204U, 701U, 1003U, 704U, 203U},   5U},
  {8U, "mode6-case0-sub5 L-V90",      {204U, 701U, 1003U, 802U, 1003U},  5U},
  {8U, "mode6-case0-sub6 R135 in",    {204U, 901U, 1003U},               3U},
  {8U, "mode6-case0-sub7 L135 out",   {204U, 901U, 1003U, 904U, 203U},   5U},
  {1U, "mode6-case0-sub8 straight case1", {209U},                       1U},
  {5U, "mode6-case0-sub9 straight case5", {209U},                       1U},
};
...
void f413_mode6_run_case0_sub(uint8_t sub)
{
  ...
  const f413_mode6_case0_sub_t* tests = (shortestRunModeParams6.fan_power > 0)
