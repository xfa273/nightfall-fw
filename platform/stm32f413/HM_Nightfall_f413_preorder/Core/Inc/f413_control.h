...
float f413_ctrl_get_gyro_z_lpf_002(void);
float f413_ctrl_get_gyro_z_lpf_005(void);
float f413_ctrl_get_gyro_z_lpf_010(void);
float f413_ctrl_get_gyro_z_lpf_020(void);
