...
void sensor_distance_load_profile_luts(void)
{
  ...
  static const uint16_t s_fr_ad[] = {
    3048, 2508, 1936, 1507, 1196, 969, 797, 669, 599, 504, 422, 357,
    306, 260, 223
  };
  ...
  static const uint16_t s_fl_ad[] = {
    3043, 2494, 1924, 1516, 1231, 1004, 835, 699, 568, 488, 422, 364,
    312, 269, 233
  };
  ...
  static const uint16_t s_front_sum_ad[] = {
    6091, 5002, 3860, 3023, 2427, 1973, 1632, 1368, 1167, 992, 844, 721,
    618, 529, 456
  };
