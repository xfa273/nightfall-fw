...
#define F_ALIGN_TARGET_FR    1663
#define F_ALIGN_TARGET_FL    2050
...
#define MATCH_POS_SENSOR_LPF_ALPHA 0.04F
#define MATCH_POS_HOLD_RELEASE_TOL 180
#define MATCH_POS_HOLD_RELEASE_TOL_ANGLE 80
