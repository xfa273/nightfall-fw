...
const ShortestRunModeParams_t shortestRunModeParams2 = {
    ...
    .alpha_l_turn_90    = 5200.0f,
    .angle_l_turn_90    = 90.0f,
    .dist_l_turn_in_90  = 16.0f,
    .dist_l_turn_out_90 = 0.5f,
    // Large 180deg
    .velocity_l_turn_180= 500.0f,
    .alpha_l_turn_180   = 3350.0f,
    .angle_l_turn_180   = 180.0f,
    .dist_l_turn_in_180 = 14.1f,
    .dist_l_turn_out_180= 11.5f,
    // 45deg In
