...
- unit002追加実装HIL（2026-09-21 JST）: 壁センサ/encoder/走行motor/fan実装、浮上固定8V/2A・debugger5V OFFをユーザ確認。FW001d688dirtyのまま6/7/8/9を各12%500ms、L前-2192/後+2581、R前+2535/後-2210、非駆動側0。左だけ想定符号が逆で目視方向確認待ち、閉ループ走行不可・極性未変更。fan20/50/80%各1.2秒→停止のコマンド完了、実回転/吸引/熱等は追認待ち。壁ADC4系統はユーザ壁設置後512平均FR1235/FL837/R1757/L1863、全壁あり・飽和なし/offset0、壁撤去後の復帰確認待ち。reset後mode0、全駆動OFF/fault0、NVM変更なし。詳細 `docs/MINI_R3_UNIT002_BRINGUP.md`。
