...
| mini_r3_0_unit001 | mini / `0x00030000` / 1 | `0x00030001` / `mini-r3-2s-fanoff-t0.9`（共通値、故障機の駆動は禁止） | High（左配線を反転済み） | あり |
| mini_r3_0_unit002 | mini / `0x00030000` / 2 | `0x00030001` / `mini-r3-2s-fanoff-t0.9`（非吸引ゲイン維持、前壁LUT拡張・実機反映待ち） | High（unit001同様の左配線を確認） | あり |
