...
| mini_r3_0_unit001 | mini / `0x00030000` / 1 | `0x00030001` / `mini-r3-2s-fanoff-t0.8`（共通値、故障機の駆動は禁止） | High（左配線を反転済み） | あり |
| mini_r3_0_unit002 | mini / `0x00030000` / 2 | `0x00030001` / `mini-r3-2s-fanoff-t0.8`（2S非吸引ユーザ調整済み、前壁追試待ち） | High（unit001同様の左配線を確認） | あり |
...
例外は維持。距離LUTはt0.5と同じで、前壁の追加測定待ち。吸引・3Sは未検証。
