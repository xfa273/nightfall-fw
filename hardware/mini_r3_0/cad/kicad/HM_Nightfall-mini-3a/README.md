...
- `HM_Nightfall-mini-3a_v0-power.kicad_sym`: MPM3610 / SI7135DP / PMPB13XNE のローカルシンボル
...
KiCad 10.0.3 の CLI で回路図ロード、ネットリスト出力、SVG 描画を確認済みです。既存 Eagle インポート由来の ERC 警告は残るため、PCB 着手前に電源ブロックだけでなく全回路の ERC ベースライン整理を行います。
